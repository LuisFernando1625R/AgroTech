...
export function AuthPage() {
  ...
  function handleRegisterSubmit(event) {
    ...
    // Alterna automaticamente pro modo login e pré-preenche o email
      ...
      <section className="top">
        <div className="container">
          <div className="rv-auth-intro">
            ...
            <p>
              {mode === "login"
                ? "Acesse sua área de gestão para acompanhar as doações dos nossos pontos de coleta."
                : "Cadastre sua ONG ou Escola para começar a receber doações dos nossos pontos de coleta."}
            </p>
          </div>

          <div className="auth-card-single">
            {mode === "login" && (
              <div className="fundo-branco auth-card-anim" key="login-card">
            ...
            {mode === "register" && (
              <div className="fundo-branco auth-card-anim" key="register-card">
